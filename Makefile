...
cr_gh_flags := --owner chr0n1x --git-repo nginx-proxy-manager-on-kubernetes --token $(GITHUB_TOKEN) --remote origin-https


prep-git:
	git config --global --add safe.directory /workspace
	git remote add origin-https https://github.com/chr0n1x/nginx-proxy-manager-on-kubernetes || :
